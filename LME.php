...
<br><br>
	<img src="https://pro2-bar-s3-cdn-cf1.myportfolio.com/9edcc3a07de000e507abe3fc9f2bea58/cd7757a2-aaf7-41ee-89b6-39fd0d65f3cd_rw_1920.jpg?h=ac03d189a268dfd9fc251e22881546a7" style="width: 100%;height: 450px;">
<br><br><br><br><br><br><br>
	<b style=" padding-left:38%; font-weight:bolder; font-size: 45px;font-family: Arial;">Limited Edition</b>
	...
	<table class="tb1">
	    ...
	    <?php 
			...
			where name like'%Limited_Edition%'";
		 				...
		 				echo "<tr>";
		 					while($row = mysqli_fetch_assoc($result)){
		 						...
		 						echo "<td class='item'>";
		 							...
		 							echo "<img src='$url' style=' width :310px; height:310px title='Click for more information' >";
	...
	<div style="width:1222px;height: 132px;font-family: Courier New;text-align: center;margin: 60px 60px;font-size: 20px;">
		<b>Get Limited Edition Sneakers</b>
		<p>"
The Converse limited edition sneaker range is a celebration of unique styles, special materials and bold designs. Offering exclusive interpretations of our classic styles, and only available in limited numbers and for a limited time, these sneakers will give your wardrobe that extra edge. Shop the Converse collection of limited edition sneakers from artists, activists and premier fashion houses now."</p>
	</div>
	<br><br><br><br>
